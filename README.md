...
A modern and scalable real-time chat application built with Django, REST APIs, and WebSockets.
It supports instant messaging, media sharing, and live user interaction.
...
Media files are uploaded via API and rendered in chat UI
🚧 Future Improvements
